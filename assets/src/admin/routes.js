...
const InitLocalStorageSettings = (props) => {
    ...
    return (
        <InitDataBaseSettingsWithHoc
            atrcStore={InteractiveLessonLocalize.store}//store from AtrcRegisterStore
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const rootElement = document.getElementById(InteractiveLessonLocalize.root_id);
    ...
    if (rootElement) {
        ...
        render(
            <InitLocalStorageSettingsWithHoc
                atrcStore={InteractiveLessonLocalize.store} //store from AtrcRegisterStore
                atrcStoreKey='InteractiveLessonLocal'//key from admin.js
            />,
            rootElement
        );
    }
