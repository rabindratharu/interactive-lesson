module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        compress: {
            main: {
                options: {
                    archive: 'interactive-lesson.zip',
                    mode: 'zip',
                },
                files: [
                    {
                        src: ['./interactive-lesson/**'],
                    },
                ],
            },
        },
        ...
        clean: {
            main: ['interactive-lesson'],
            zip: ['interactive-lesson.zip'],
        },
        ...
        makepot: {
            target: {
                options: {
                    domainPath: '/',
                    mainFile: 'interactive-lesson.php',
                    potFilename: 'languages/interactive-lesson.pot',
                    potHeaders: {
                        poedit: true,
        ...
        checktextdomain: {
            standard: {
                options: {
                    text_domain: 'interactive-lesson', //Specify allowed domain(s)
                    keywords: [
